...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOKEN_PALAVRA_CHAVE = 3,        /* TOKEN_PALAVRA_CHAVE  */
  YYSYMBOL_TOKEN_VALOR = 4,                /* TOKEN_VALOR  */
  YYSYMBOL_TOKEN_OPERADOR_COMP = 5,        /* TOKEN_OPERADOR_COMP  */
  YYSYMBOL_6_ = 6,                         /* '+'  */
  YYSYMBOL_7_ = 7,                         /* '-'  */
  YYSYMBOL_8_ = 8,                         /* '*'  */
  YYSYMBOL_9_ = 9,                         /* '/'  */
  ...
  YYSYMBOL_bloco_comandos = 18,            /* bloco_comandos  */
  YYSYMBOL_comando = 19,                   /* comando  */
  YYSYMBOL_comando_fechado = 20,           /* comando_fechado  */
  YYSYMBOL_comando_aberto = 21,            /* comando_aberto  */
  YYSYMBOL_comando_nao_se = 22,            /* comando_nao_se  */
  YYSYMBOL_condicao = 23,                  /* condicao  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "TOKEN_PALAVRA_CHAVE",
  "TOKEN_VALOR", "TOKEN_OPERADOR_COMP", "'+'", "'-'", "'*'", "'/'", "'='",
  "'{'", "'}'", "','", "'('", "')'", "$accept", "programa",
  "bloco_comandos", "comando", "comando_fechado", "comando_aberto",
  "comando_nao_se", "condicao", "expressao", YY_NULLPTR
};
...
{
     -29,     2,   -29,     3,    -2,   -29,   -29,   -29,   -29,    17,
      19,    21,    13,    19,    19,   -29,    28,   -29,    31,    19,
      19,    19,    19,    19,    19,    56,    56,   -29,    27,   -29,
      56,    16,    16,   -29,   -29,    48,    25,   -29,    37,    19,
      35,   -29,    56,   -29,    41,   -29
};
...
{
       2,     0,     1,    13,     0,     3,     6,     7,     8,    18,
       0,     0,     0,     0,     0,    18,     0,     4,     0,     0,
       0,     0,     0,     0,     0,    15,    14,    23,     0,     4,
      17,    19,    20,    21,    22,    11,    10,     5,     0,     0,
       0,    16,    12,     4,     0,     9
};
...
{
     -29,   -29,   -28,    46,   -29,   -29,   -29,   -29,   -10
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     1,    28,    37,     6,     7,     8,    11,    12
};
...
{
      16,    38,     2,    25,    26,     3,     4,     9,    13,    30,
      31,    32,    33,    34,    35,    44,    18,    10,    19,    20,
      21,    22,    23,    15,    22,    23,    24,    14,    40,    42,
       3,     4,    17,    10,    20,    21,    22,    23,     0,    36,
       3,     4,    29,    27,     3,     4,    43,     5,     0,    41,
       0,     0,     0,    45,    20,    21,    22,    23,     0,     0,
       0,    39,    20,    21,    22,    23
};

static const yytype_int8 yycheck[] =
{
      10,    29,     0,    13,    14,     3,     4,     4,    10,    19,
      20,    21,    22,    23,    24,    43,     3,    14,     5,     6,
       7,     8,     9,     4,     8,     9,    13,    10,     3,    39,
       3,     4,    11,    14,     6,     7,     8,     9,    -1,    12,
       3,     4,    11,    15,     3,     4,    11,     1,    -1,    12,
      -1,    -1,    -1,    12,     6,     7,     8,     9,    -1,    -1,
      -1,    13,     6,     7,     8,     9
};
...
{
       0,    17,     0,     3,     4,    19,    20,    21,    22,     4,
      14,    23,    24,    10,    10,     4,    24,    11,     3,     5,
       6,     7,     8,     9,    13,    24,    24,    15,    18,    11,
      24,    24,    24,    24,    24,    24,    12,    19,    18,    13,
       3,    12,    24,    11,    18,    12
};
...
#line 67 "parser.y"
                       { 
        if ((yyvsp[0].sval) != NULL && strlen((yyvsp[0].sval)) > 0) { fprintf(output_file, "%s", (yyvsp[0].sval)); }
        free((yyvsp[0].sval)); 
    }
#line 1143 "parser.tab.c"
    break;

  case 4: /* bloco_comandos: %empty  */
#line 75 "parser.y"
           { (yyval.sval) = strdup(""); }
#line 1149 "parser.tab.c"
    break;

  case 5: /* bloco_comandos: bloco_comandos comando  */
#line 76 "parser.y"
...
#line 86 "parser.y"
        ...
        if (strcmp((yyvsp[-8].sval), "SE") == 0 && strcmp((yyvsp[-3].sval), "SENAO") == 0) {
            asprintf(&temp_str, "if (%s) {\n%s} else {\n%s}\n", (yyvsp[-7].sval), (yyvsp[-5].sval), (yyvsp[-1].sval));
        }
        (yyval.sval) = (temp_str) ? temp_str : strdup("");
        free((yyvsp[-8].sval)); free((yyvsp[-7].sval)); free((yyvsp[-5].sval)); free((yyvsp[-3].sval)); free((yyvsp[-1].sval));
    }
...
#line 113 "parser.y"
        ...
        (yyval.sval) = (temp_str) ? temp_str : strdup("");
        free((yyvsp[-5].sval)); free((yyvsp[-4].sval)); free((yyvsp[-3].sval)); free((yyvsp[-1].sval));
    }
